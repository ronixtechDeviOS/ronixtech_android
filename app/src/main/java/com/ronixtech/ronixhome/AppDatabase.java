...
@Database(entities = {Type.class, WifiNetwork.class, Line.class, SoundDeviceData.class, PIRData.class, Device.class, Room.class, Floor.class, Place.class, User.class}, version = 20, exportSchema =  false)
